...
int8_t Plugin_123_si7013_startConv(uint8_t i2caddr, uint8_t datatype, uint8_t resolution)
{
  ...
  */
  ...
  // Temperature
  } else  if (datatype == SI7013_MEASURE_TEMP ||datatype == SI7013_MEASURE_TEMP_HM || datatype == SI7013_READ_TEMP_FROM_HUM) {
...
int8_t Plugin_123_si7013_readValues(uint8_t i2caddr, uint8_t resolution, uint8_t filter_power)
{
  ...
  error |= Plugin_123_si7013_startConv(i2caddr, SI7013_MEASURE_HUM, resolution); //measures both humidity and temperature 
