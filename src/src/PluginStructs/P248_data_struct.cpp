...
float P248_data_struct::readHumidity()
{
  ...
  //const float humidity = static_cast<float>(rawData) * 0.000095f; //humidity seems off like 20% less than actual
  const float humidity = (static_cast<float>(rawData)*100)/1048576;
